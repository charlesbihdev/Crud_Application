...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1877443282ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=crud&table=user_info">`crud`.`user_info`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fred_db&table=wp_links">`fred_db`.`wp_links`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fred_db&table=wp_posts">`fred_db`.`wp_posts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fred_db&table=wp_users">`fred_db`.`wp_users`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="475f2f756e705b22333b357c2b463c65">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="crud" targettable="user_info">
            ...
            Queried time
                            ...
                            <span class="query">UPDATE `user_info` SET `name` = &#039;Brah Benk&#039; WHERE `user_info`.`id` = 9;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="crud" targettable="user_info">
                            <div class="action_content">
